...
@protocol IGSTListCollectionContext <NSObject>
...
/**
 ...
 ```
 [self.collectionContext performBatchItemUpdates:^ (id<IGSTListBatchContext> batchContext>){
...
- (void)performBatchAnimated:(BOOL)animated
                     updates:(void (^)(id<IGSTListBatchContext> batchContext))updates
                  completion:(nullable void (^)(BOOL finished))completion;
