...
/**
 An instance of `IGSTListBatchUpdateData` takes section indexes and item index paths 
...
@interface IGSTListBatchUpdateData : NSObject
...
/**
 Section moves.
 */
@property (nonatomic, strong, readonly) NSSet<IGSTListMoveIndex *> *moveSections;
...
/**
 Item moves.
 */
@property (nonatomic, strong, readonly) NSArray<IGSTListMoveIndexPath *> *moveIndexPaths;
...
- (instancetype)initWithInsertSections:(NSIndexSet *)insertSections
                      ...
                      deleteIndexPaths:(NSArray<NSIndexPath *> *)deleteIndexPaths
                        moveIndexPaths:(NSArray<IGSTListMoveIndexPath *> *)moveIndexPaths NS_DESIGNATED_INITIALIZER;
