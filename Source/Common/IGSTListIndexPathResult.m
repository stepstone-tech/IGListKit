...
#import "IGSTListIndexPathResult.h"
#import "IGSTListIndexPathResultInternal.h"

@implementation IGSTListIndexPathResult {
...
- (IGSTListIndexPathResult *)resultForBatchUpdates {
    ...
    NSArray<IGSTListMoveIndexPath *> *moves = self.moves;
    NSMutableArray<IGSTListMoveIndexPath *> *filteredMoves = [moves mutableCopy];
    ...
    for (NSInteger i = moveCount - 1; i >= 0; i--) {
        IGSTListMoveIndexPath *move = moves[i];
    ...
    return [[IGSTListIndexPathResult alloc] initWithInserts:[inserts allObjects]
