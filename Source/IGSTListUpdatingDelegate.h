...
typedef void (^IGSTListUpdatingCompletion)(BOOL finished);
...
@protocol IGSTListUpdatingDelegate <NSObject>
...
/**
 ...
 @param fromObjects The previous objects in the collection view. Objects must conform to `IGSTListDiffable`.
 @param toObjects The new objects in collection view. Objects must conform to `IGSTListDiffable`.
...
- (void)performUpdateWithCollectionView:(UICollectionView *)collectionView
                            fromObjects:(nullable NSArray<id <IGSTListDiffable>> *)fromObjects
                              toObjects:(nullable NSArray<id <IGSTListDiffable>> *)toObjects
                               animated:(BOOL)animated
                  objectTransitionBlock:(IGSTListObjectTransitionBlock)objectTransitionBlock
...
- (void)performUpdateWithCollectionView:(UICollectionView *)collectionView
                               animated:(BOOL)animated
                            itemUpdates:(IGSTListItemUpdateBlock)itemUpdates
                             completion:(nullable IGSTListUpdatingCompletion)completion;
