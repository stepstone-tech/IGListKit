...
/**
 A protocol that returns data to power cells in an `IGSTListBindingSectionController`.
 */
NS_SWIFT_NAME(ListBindingSectionControllerDataSource)
@protocol IGSTListBindingSectionControllerDataSource <NSObject>
 ...
 */
- (NSArray<id<IGSTListDiffable>> *)sectionController:(IGSTListBindingSectionController *)sectionController
 ...
 */
- (UICollectionViewCell<IGSTListBindable> *)sectionController:(IGSTListBindingSectionController *)sectionController
 ...
 */
- (CGSize)sectionController:(IGSTListBindingSectionController *)sectionController
