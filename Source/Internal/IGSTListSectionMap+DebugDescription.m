...
@implementation IGSTListSectionMap (DebugDescription)

- (NSArray<NSString *> *)debugDescriptionLines {
    NSMutableArray *debug = [NSMutableArray new];
#if IGLK_DEBUG_DESCRIPTION_ENABLED
    [self enumerateUsingBlock:^(id object, IGSTListSectionController *sectionController, NSInteger section, BOOL *stop) {
        if ([sectionController isKindOfClass:[IGSTListBindingSectionController class]]) {
