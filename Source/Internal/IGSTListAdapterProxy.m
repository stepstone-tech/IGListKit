...
/**
 Define messages that you want the IGSTListAdapter object to intercept. Pattern copied from
...
@interface IGSTListAdapterProxy () {
    __weak id _collectionViewTarget;
    __weak id _scrollViewTarget;
    __weak IGSTListAdapter *_interceptor;
}

@end

@implementation IGSTListAdapterProxy
