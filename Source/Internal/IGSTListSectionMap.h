...
/**
 The IGSTListSectionMap provides a way to map a collection of objects to a collection of section controllers and achieve
 constant-time lookups O(1).

 IGSTListSectionMap is a mutable object and does not guarantee thread safety.
 */
IGLK_SUBCLASSING_RESTRICTED
@interface IGSTListSectionMap : NSObject <NSCopying>
 ...
 */
- (void)updateWithObjects:(NSArray <id <NSObject>> *)objects sectionControllers:(NSArray <IGSTListSectionController *> *)sectionControllers;
