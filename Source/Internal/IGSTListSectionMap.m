...
@interface IGSTListSectionMap ()

// both of these maps allow fast lookups of objects, list objects, and indexes
@property (nonatomic, strong, readonly, nonnull) NSMapTable<id, IGSTListSectionController *> *objectToSectionControllerMap;
@property (nonatomic, strong, readonly, nonnull) NSMapTable<IGSTListSectionController *, NSNumber *> *sectionControllerToSectionMap;

@property (nonatomic, strong, nonnull) NSMutableArray *mObjects;

@end

@implementation IGSTListSectionMap
...
- (IGSTListSectionController *)sectionControllerForSection:(NSInteger)section {
...
- (void)updateWithObjects:(NSArray *)objects sectionControllers:(NSArray *)sectionControllers {
    ...
    [objects enumerateObjectsUsingBlock:^(id object, NSUInteger idx, BOOL *stop) {
        IGSTListSectionController *sectionController = sectionControllers[idx];
...
- (nullable IGSTListSectionController *)sectionControllerForObject:(id)object {
...
- (void)reset {
    [self enumerateUsingBlock:^(id  _Nonnull object, IGSTListSectionController * _Nonnull sectionController, NSInteger section, BOOL * _Nonnull stop) {
...
- (void)enumerateUsingBlock:(void (^)(id object, IGSTListSectionController *sectionController, NSInteger section, BOOL *stop))block {
    ...
    for (NSInteger section = 0; section < objects.count; section++) {
        ...
        IGSTListSectionController *sectionController = [self sectionControllerForObject:object];
...
- (id)copyWithZone:(NSZone *)zone {
    IGSTListSectionMap *copy = [[IGSTListSectionMap allocWithZone:zone] initWithMapTable:self.objectToSectionControllerMap];
    if (copy != nil) {
