...
@interface IGSTListDisplayHandler : NSObject

/**
 Tells the handler that a cell will be displayed in the IGSTListAdapter.
...
/**
 Tells the handler that a cell did end display in the IGSTListAdapter.
...
/**
 Tells the handler that a supplementary view will be displayed in the IGSTListAdapter.
...
/**
 Tells the handler that a supplementary view did end display in the IGSTListAdapter.
