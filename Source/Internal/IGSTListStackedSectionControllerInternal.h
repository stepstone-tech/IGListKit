...
#import "IGSTListStackedSectionController.h"

@interface IGSTListStackedSectionController ()
<
IGSTListBatchContext,
IGSTListCollectionContext,
IGSTListDisplayDelegate,
IGSTListScrollDelegate,
IGSTListWorkingRangeDelegate
>

@property (nonatomic, strong, readonly) NSOrderedSet<__kindof IGSTListSectionController *> *sectionControllers;

/// An array the length of the total number of items in the stack, pointing to a section controller for the item index.
@property (nonatomic, copy) NSArray<IGSTListSectionController *> *sectionControllersForItems;
...
@property (nonatomic, strong) id<IGSTListBatchContext> forwardingBatchContext;
