...
@class IGSTListAdapterUpdater;

NS_ASSUME_NONNULL_BEGIN

/**
 A protocol that receives events about `IGSTListAdapterUpdater` operations.
 */
NS_SWIFT_NAME(ListAdapterUpdaterDelegate)
@protocol IGSTListAdapterUpdaterDelegate <NSObject>
 ...
 */
- (void)listAdapterUpdater:(IGSTListAdapterUpdater *)listAdapterUpdater willPerformBatchUpdatesWithCollectionView:(UICollectionView *)collectionView;
 ...
 */
- (void)listAdapterUpdater:(IGSTListAdapterUpdater *)listAdapterUpdater
    didPerformBatchUpdates:(IGSTListBatchUpdateData *)updates
 ...
 */
- (void)listAdapterUpdater:(IGSTListAdapterUpdater *)listAdapterUpdater willReloadDataWithCollectionView:(UICollectionView *)collectionView;
 ...
 */
- (void)listAdapterUpdater:(IGSTListAdapterUpdater *)listAdapterUpdater didReloadDataWithCollectionView:(UICollectionView *)collectionView;
    ...
    willCrashWithException:(NSException *)exception
               fromObjects:(nullable NSArray *)fromObjects
                 toObjects:(nullable NSArray *)toObjects
                   updates:(IGSTListBatchUpdateData *)updates;
