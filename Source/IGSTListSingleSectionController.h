...
typedef void (^IGSTListSingleSectionCellConfigureBlock)(id item, __kindof UICollectionViewCell *cell);
...
typedef CGSize (^IGSTListSingleSectionCellSizeBlock)(id item, id<IGSTListCollectionContext> _Nullable collectionContext);

@class IGSTListSingleSectionController;

/**
 A delegate that can receive selection events on an `IGSTListSingleSectionController`.
 */
NS_SWIFT_NAME(ListSingleSectionControllerDelegate)
@protocol IGSTListSingleSectionControllerDelegate <NSObject>
 ...
 */
- (void)didSelectSectionController:(IGSTListSingleSectionController *)sectionController
...
/**
 ...
 to configure the cell, and a block to return the size of a cell, you can use an `IGSTListAdapter`-powered list with a
 simpler architecture.
 */
IGLK_SUBCLASSING_RESTRICTED
NS_SWIFT_NAME(ListSingleSectionController)
@interface IGSTListSingleSectionController : IGSTListSectionController
...
/**
 ...
 (usually `self`) or the `IGSTListAdapter`. Pass in locally scoped objects or use `weak` references!
 */
- (instancetype)initWithCellClass:(Class)cellClass
                   configureBlock:(IGSTListSingleSectionCellConfigureBlock)configureBlock
                        sizeBlock:(IGSTListSingleSectionCellSizeBlock)sizeBlock;
 ...
 */
@property (nonatomic, weak, nullable) id<IGSTListSingleSectionControllerDelegate> selectionDelegate;
