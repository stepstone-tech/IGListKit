...
@implementation IGSTListReloadDataUpdater
...
- (void)performUpdateWithCollectionView:(UICollectionView *)collectionView
                  ...
                  objectTransitionBlock:(IGSTListObjectTransitionBlock)objectTransitionBlock
                             completion:(IGSTListUpdatingCompletion)completion {
...
- (void)reloadDataWithCollectionView:(UICollectionView *)collectionView reloadUpdateBlock:(IGSTListReloadUpdateBlock)reloadUpdateBlock completion:(IGSTListUpdatingCompletion)completion {
    reloadUpdateBlock();
    [self synchronousReloadDataWithCollectionView:collectionView];
    if (completion) {
        completion(YES);
