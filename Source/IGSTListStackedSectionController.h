...
/**
 An instance of `IGSTListStackedSectionController` is a clustered section controller, composed of many child section
...
@interface IGSTListStackedSectionController : IGSTListSectionController
 ...
 */
- (instancetype)initWithSectionControllers:(NSArray <IGSTListSectionController *> *)sectionControllers NS_DESIGNATED_INITIALIZER;
