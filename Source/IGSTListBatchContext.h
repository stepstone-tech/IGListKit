...
/**
 Objects conforming to the IGSTListBatchContext protocol provide a way for section controllers to mutate their cells or
 reload everything within the section.
 */
NS_SWIFT_NAME(ListBatchContext)
@protocol IGSTListBatchContext <NSObject>
 ...
 */
- (void)reloadInSectionController:(IGSTListSectionController *)sectionController
 ...
 */
- (void)insertInSectionController:(IGSTListSectionController *)sectionController
                        atIndexes:(NSIndexSet *)indexes;
 ...
 */
- (void)deleteInSectionController:(IGSTListSectionController *)sectionController
                        atIndexes:(NSIndexSet *)indexes;
 ...
 */
- (void)moveInSectionController:(IGSTListSectionController *)sectionController
