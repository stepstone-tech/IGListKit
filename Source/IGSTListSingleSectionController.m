...
#import "IGSTListSingleSectionController.h"

#import <IGListKitStSt/IGSTListAssert.h>

@interface IGSTListSingleSectionController ()
...
@property (nonatomic, strong, readonly) IGSTListSingleSectionCellConfigureBlock configureBlock;
@property (nonatomic, strong, readonly) IGSTListSingleSectionCellSizeBlock sizeBlock;

@property (nonatomic, strong) id item;

@end

@implementation IGSTListSingleSectionController
